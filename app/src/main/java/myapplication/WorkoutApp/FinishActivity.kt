...
import myapplication.WorkoutApp.databinding.ActivityFinishBinding
...
class FinishActivity : AppCompatActivity() {
    ...
    private fun addDateToDatabase(historyDao: HistoryDao) {
        ...
        BranchEvent("EXERCISE_COMPLETE")
            .addCustomDataProperty("user_id", sessionManager.getUserId().toString())
            .logEvent(this)
